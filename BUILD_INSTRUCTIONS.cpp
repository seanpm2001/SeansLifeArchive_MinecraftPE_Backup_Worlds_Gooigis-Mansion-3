...
{
    // Starter info
    std::cout << "Build instructions for GitHub/seanpm2001/SeansLifeArchive_MinecraftPE_Backup_Worlds_Gooigis-Mansion-3\n";
    std::cout << "This repository is an archive of all versions of my Minecraft PE world: Gooigis-Mansion-3\n";
    ...
    std::cout << "To start using the world, locate your device storage and go to: games/com.mojang/MinecraftWorlds/ then cut/copy and paste the directory containing the world code OAmmX2iERwA into this folder (you can also use the zip file and extract it) you do not need to remove extra files before running the game, just make sure not to do this while the game is running";
    std::cout << "Please also make sure that there is not already another world in your MinecraftWorlds folder labeled Gooigis mansion 3.";
    // Outro
